...
do
  ...
  aws ssm put-parameter --profile csDev --region ap-southeast-1 --overwrite --type "String" \
    --name $key \
    --value $val
done

echo "Done. Pushed configurations to AWS parameter store in dev environment."
